...
(function( window, undefined ) {
    ...
    KeycloakAuthorization.prototype.init = function () {
        ...
        request.open('GET', this.keycloak.authServerUrl + '/realms/' + this.keycloak.realm + '/.well-known/uma2-configuration');
     ...
     */
    KeycloakAuthorization.prototype.authorize = function (authorizationRequest) {
        var _instance = this;
        ...
        this.then = function (onGrant, onDeny, onError) {
            if (authorizationRequest && authorizationRequest.ticket) {
                ...
                var params = "grant_type=urn:ietf:params:oauth:grant-type:uma-ticket&client_id=" + this.keycloak.clientId + "&ticket=" + authorizationRequest.ticket;
     ...
     */
    KeycloakAuthorization.prototype.entitlement = function (resourceServerId, authorizationRequest) {
        var _instance = this;
        ...
        this.then = function (onGrant, onDeny, onError) {
            ...
            var params = "grant_type=urn:ietf:params:oauth:grant-type:uma-ticket&client_id=" + this.keycloak.clientId;
